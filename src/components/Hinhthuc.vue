  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <b
            class="relative flex-1 inline-block max-w-full mq800:text-7xl mq450:text-lgi"
        ...
        >
          ...
          >
            ...
            >
            <i
              v-if="selectedOption === 'Quét QR CODE'"
              class="text-green-500 fas fa-check"
            ></i>
          </div>
          <div
            class="self-stretch rounded-6xl bg-white box-border border-[0.25px] flex-1 flex items-end justify-start py-0 px-[19px] relative gap-[17px] max-w-full mq800:flex-wrap"
          ...
          >
            <div
              class="h-full w-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px] rounded-6xl bg-white box-border border-[0.25px] border-solid border-gray-100"
            />
            <div class="flex flex-col items-start justify-start px-0 pt-2 pb-0">
              <img
            ...
            >
              ...
              <i
                v-if="selectedOption === 'Ví điện tử'"
                class="text-green-500 fas fa-check"
              ></i>
            </div>
          </div>
          ...
          >
            <div
              ...
              :class="{
                'selected-option':
                  selectedOption === 'Thẻ ATM có Internet Banking',
              }"
            ...
            >
              ...
              >
                ...
                <i
                  v-if="selectedOption === 'Thẻ ATM có Internet Banking'"
                  class="text-green-500 fas fa-check"
                ></i>
              </div>
            </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <div
              class="flex flex-col items-end self-stretch justify-start max-w-full text-center text-gray-200 font-inter"
            >
              <div
                class="w-[318px] flex flex-row items-start justify-end py-0 px-[30px] box-border"
              >
                <div
                  class="flex-1 flex flex-row items-start justify-start pt-0 px-0 pb-[324px] z-[4] mq450:pb-[211px] mq450:box-border"
                >
                  <div
                    class="flex-1 rounded-8xs flex flex-row items-start justify-start py-0 pr-px pl-0 gap-[27px] border-[2px] border-solid border-gray-100 mq450:flex-wrap mq450:pl-px mq450:pt-px mq450:pb-px mq450:box-border"
                  >
                    <div
                      class="h-10 text-11xl text-black flex-1 relative font-semibold flex items-center justify-center min-w-[117px] mq450:text-3xl"
                    >
                      {{ selectedPackageInfo.tenGoiHatSoi || "Gói Hạt Sồi" }}
                    </div>
                    <div
                      class="flex flex-col items-start justify-start pt-2.5 px-1 pb-0"
                    >
                      <i
                      ...
                      <div class="dropdown-container">
                        ...
                        >
                          <!-- Dropdown list -->
                          <div
                            class="w-[214px] text-11xl flex-col items-start justify-start text-left text-black font-segoe-ui"
                          >
                            <div
                              v-for="(packages, index) in packages"
                              :key="index"
                              class="self-stretch h-[54px] rounded-8xs bg-gainsboro flex flex-row items-center justify-center py-2.5 px-2 box-border whitespace-nowrap package-item"
                              @click="onPackageSelect(packages.name)"
                            >
                              <div
                                class="h-[37px] flex-1 relative tracking-[-0.04px] font-semibold inline-block package-name"
                              >
                                {{ packages.name }}
                              </div>
                            </div>
            ...
            >
              ...
              >
                ...
                <p class="m-0 mb-4">
                  Sồi theo gói: {{ selectedPackageInfo.soi }}
                </p>
              </div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      class="h-[85px] w-[525px] relative rounded-6xl bg-mediumgreen-100 hidden max-w-full"
                      style="margin-top: 2px"
                    />
                    <div
                      class="text-13xl flex-1 relative font-semibold inline-block max-w-full cursor-pointer z-[2] mq800:text-5xl mq450:text-lg"
